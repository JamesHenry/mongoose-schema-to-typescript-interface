...
program
    ...
    var outputDir = cmd.outputDir, moduleName = cmd.moduleName, extendRefs = cmd.extendRefs;
    if (!outputDir) {
    ...
    var output = utilities_1.generateOutput(moduleName, currentDir, resolvedSchemaFiles, extendRefs);
